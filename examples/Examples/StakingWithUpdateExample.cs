...
namespace Hiero.Examples
{
    ...
    public class StakingWithUpdateExample
    {
        ...
        {
            Console.WriteLine("Staking With Update Example Start!");
            /// <summary>
            /// Step 0:
            ...
            /// </summary>
            AccountInfo accountInfo = new AccountInfoQuery { AccountId = newAccountId }.Execute(client);
            if (accountInfo.StakingInfo.StakedAccountId.Equals(stakedAccountId))
            {
                Console.WriteLine("New account staking info: " + accountInfo.StakingInfo);
            }
            else
            {
            ...
            /// </summary>
            Console.WriteLine("Updating the new account...(unstake Hbar).");
            ...
            /// </summary>
            accountInfo = new AccountInfoQuery { AccountId = newAccountId }.Execute(client);
            ...
            .GetReceipt(client);
            client.Dispose();
            Console.WriteLine("Staking With Update Example Complete!");
        }
    }
}