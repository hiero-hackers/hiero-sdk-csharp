...
{
    /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenDeleteIntegrationTest"]' />
    public class TokenDeleteIntegrationTest
    {
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenDeleteIntegrationTest.CanDeleteToken"]' />
        ...
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenDeleteIntegrationTest.CanDeleteTokenWithOnlyAdminKeySet"]' />
        ...
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenDeleteIntegrationTest.CannotDeleteTokenWhenAdminKeyDoesNotSignTransaction"]' />
        ...
        [Fact]
        /// <include file="TokenDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenDeleteIntegrationTest.CannotDeleteTokenWhenTokenIDIsNotSet"]' />
