...
{
    /// <include file="TokenFeeScheduleUpdateIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenFeeScheduleUpdateIntegrationTest"]' />
    public class TokenFeeScheduleUpdateIntegrationTest
    {
        [Fact]
        /// <include file="TokenFeeScheduleUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenFeeScheduleUpdateIntegrationTest.CanUpdateToken"]' />
        ...
        [Fact]
        /// <include file="TokenFeeScheduleUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenFeeScheduleUpdateIntegrationTest.CannotUpdateWithAnyOtherKey"]' />
