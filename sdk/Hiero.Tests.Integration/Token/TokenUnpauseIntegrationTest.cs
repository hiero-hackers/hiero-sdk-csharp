...
{
    /// <include file="TokenUnpauseIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenUnpauseIntegrationTest"]' />
    public class TokenUnpauseIntegrationTest
    {
        [Fact]
        /// <include file="TokenUnpauseIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenUnpauseIntegrationTest.CanExecuteTokenUnpauseTransaction"]' />
        ...
        [Fact]
        /// <include file="TokenUnpauseIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenUnpauseIntegrationTest.CannotUnpauseWithNoTokenId"]' />
