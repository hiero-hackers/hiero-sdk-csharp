...
{
    /// <include file="TokenRevokeKycIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenRevokeKycIntegrationTest"]' />
    public class TokenRevokeKycIntegrationTest
    {
        [Fact]
        /// <include file="TokenRevokeKycIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRevokeKycIntegrationTest.CanRevokeKycAccountWithToken"]' />
        ...
        [Fact]
        /// <include file="TokenRevokeKycIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRevokeKycIntegrationTest.CannotRevokeKycToAccountOnTokenWhenTokenIDIsNotSet"]' />
        ...
        [Fact]
        /// <include file="TokenRevokeKycIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRevokeKycIntegrationTest.CannotRevokeKycToAccountOnTokenWhenAccountIDIsNotSet"]' />
        ...
        [Fact]
        /// <include file="TokenRevokeKycIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRevokeKycIntegrationTest.CannotRevokeKycToAccountOnTokenWhenAccountWasNotAssociatedWith"]' />
