...
{
    /// <include file="TokenTransferIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenTransferIntegrationTest"]' />
    public class TokenTransferIntegrationTest
    {
        [Fact]
        /// <include file="TokenTransferIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenTransferIntegrationTest.TokenTransferTest"]' />
        ...
        [Fact]
        /// <include file="TokenTransferIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenTransferIntegrationTest.InsufficientBalanceForFee"]' />
