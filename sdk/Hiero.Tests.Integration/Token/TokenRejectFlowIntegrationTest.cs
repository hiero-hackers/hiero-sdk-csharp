...
{
    /// <include file="TokenRejectFlowIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenRejectFlowIntegrationTest"]' />
    public class TokenRejectFlowIntegrationTest
    {
        [Fact]
        /// <include file="TokenRejectFlowIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRejectFlowIntegrationTest.CanExecuteTokenRejectFlowForFungibleToken"]' />
        ...
        [Fact]
        /// <include file="TokenRejectFlowIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRejectFlowIntegrationTest.CanExecuteTokenRejectFlowForFungibleTokenAsync"]' />
        ...
        [Fact]
        /// <include file="TokenRejectFlowIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRejectFlowIntegrationTest.CanExecuteTokenRejectFlowForNft"]' />
        ...
        [Fact]
        /// <include file="TokenRejectFlowIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenRejectFlowIntegrationTest.CanExecuteTokenRejectFlowForNftWhenRejectingOnlyPartOfOwnedNFTs"]' />
