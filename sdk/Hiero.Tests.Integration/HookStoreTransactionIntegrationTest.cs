...
{
    /// <include file="HookStoreTransactionIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.HookStoreTransactionIntegrationTest"]' />
    public class HookStoreTransactionIntegrationTest
    {
        ...
        [Fact]
        /// <include file="HookStoreTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.HookStoreTransactionIntegrationTest.LambdaSStoreUpdatesStorageWithValidSignature"]' />
        public virtual void LambdaSStoreUpdatesStorageWithValidSignature()
        {
        ...
        [Fact]
        /// <include file="HookStoreTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.HookStoreTransactionIntegrationTest.LambdaSStoreFailsWithoutProperSignature"]' />
        public virtual void LambdaSStoreFailsWithoutProperSignature()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                // Deploy hook contract
        ...
        [Fact]
        /// <include file="HookStoreTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.HookStoreTransactionIntegrationTest.LambdaSStoreFailsWithNonExistentHookId"]' />
        public virtual void LambdaSStoreFailsWithNonExistentHookId()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
        ...
        [Fact]
        /// <include file="HookStoreTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.HookStoreTransactionIntegrationTest.LambdaSStoreTooManyStorageUpdatesFails"]' />
        public virtual void LambdaSStoreTooManyStorageUpdatesFails()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                // Deploy hook contract
                ...
                // TODO: Assert.Contains(exception.Message, ResponseStatus.TooManyLambdaStorageUpdates.ToString());
            }
        }
