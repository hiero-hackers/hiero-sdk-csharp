...
{
    /// <include file="FeeSchedulesTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.FeeSchedulesTest"]' />
    public class FeeSchedulesTest
    {
        [Fact]
        /// <include file="FeeSchedulesTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FeeSchedulesTest.CanFetchFeeSchedules"]' />
