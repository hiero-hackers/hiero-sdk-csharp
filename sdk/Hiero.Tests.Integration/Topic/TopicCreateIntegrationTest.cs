...
{
    /// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TopicCreateIntegrationTest"]' />
    public class TopicCreateIntegrationTest
    {
        [Fact] 
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.CanCreateTopic"]' />
        ...
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.CanCreateTopicWithNoFieldsSet"]' />
        ...
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.CreatesAndUpdatesRevenueGeneratingTopic"]' />
        ...
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.FailsToCreateRevenueGeneratingTopicWithInvalidFeeExemptKey"]' />
		public virtual void FailsToCreateRevenueGeneratingTopicWithInvalidFeeExemptKey()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                ...
                Assert.Equal((Proto.Services.ResponseCodeEnum)exception.Status, Proto.Services.ResponseCodeEnum.FeeExemptKeyListContainsDuplicatedKeys);
                ...
                Assert.Equal((Proto.Services.ResponseCodeEnum)exception3.Receipt.Status, Proto.Services.ResponseCodeEnum.MaxEntriesForFeeExemptKeyListExceeded);
            }
        }
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.FailsToUpdateFeeScheduleKeyWithoutPermissions"]' />
		public virtual void FailsToUpdateFeeScheduleKeyWithoutPermissions()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                ...
                Assert.Equal((Proto.Services.ResponseCodeEnum)exception.Receipt.Status, Proto.Services.ResponseCodeEnum.FeeScheduleKeyCannotBeUpdated);
            }
        }
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.FailsToUpdateCustomFeesWithoutFeeScheduleKey"]' />
		public virtual void FailsToUpdateCustomFeesWithoutFeeScheduleKey()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
				...
				ReceiptStatusException exception = Assert.Throws<ReceiptStatusException>(updateExecutable);
				Assert.Equal((Proto.Services.ResponseCodeEnum)exception.Receipt.Status, Proto.Services.ResponseCodeEnum.FeeScheduleKeyNotSet);
            }
        }
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.ChargesHbarFeesWithLimitsApplied"]' />
        ...
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.ExemptsFeeExemptKeysFromHbarFees"]' />
        ...
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.CreateTopicTransactionShouldAssignAutomaticallyAutoRenewAccountId"]' />
        ...
        [Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.CreateTopicTransactionWithTransactionIdShouldAssignAutoRenewAccountIdToTransactionIdAccountId"]' />
		...
		[Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.CanClearCustomFeesListAndFeeExemptKeysList"]' />
		...
		[Fact]
		/// <include file="TopicCreateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicCreateIntegrationTest.CanUpdateTopicWithoutSpecifyingAnythingTopicShouldHaveTheSameValues"]' />
