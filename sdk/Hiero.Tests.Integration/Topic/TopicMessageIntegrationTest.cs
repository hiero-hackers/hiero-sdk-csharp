...
{
    /// <include file="TopicMessageIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TopicMessageIntegrationTest"]' />
    public class TopicMessageIntegrationTest
    {
        [Fact]
        /// <include file="TopicMessageIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicMessageIntegrationTest.CanReceiveATopicMessage"]' />
        ...
        [Fact]
        /// <include file="TopicMessageIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicMessageIntegrationTest.CanReceiveALargeTopicMessage"]' />
        ...
        [Fact]
        /// <include file="TopicMessageIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TopicMessageIntegrationTest.UnsubscribingDoesNotLogRetryWarnings"]' />
