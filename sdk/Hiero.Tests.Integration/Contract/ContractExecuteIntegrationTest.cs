...
{
    /// <include file="ContractExecuteIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.ContractExecuteIntegrationTest"]' />
    public class ContractExecuteIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractExecuteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractExecuteIntegrationTest.CanExecuteContractMethods"]' />
        public virtual void CanExecuteContractMethods()
        {
        ...
        [Fact]
        /// <include file="ContractExecuteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractExecuteIntegrationTest.CannotExecuteContractWhenContractIDIsNotSet"]' />
        public virtual void CannotExecuteContractWhenContractIDIsNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
        ...
        [Fact]
        /// <include file="ContractExecuteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractExecuteIntegrationTest.CannotExecuteContractWhenContractFunctionParametersAreNotSet"]' />
        public virtual void CannotExecuteContractWhenContractFunctionParametersAreNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
        ...
        [Fact]
        /// <include file="ContractExecuteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractExecuteIntegrationTest.CannotExecuteContractWhenGasIsNotSet"]' />
        public virtual void CannotExecuteContractWhenGasIsNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
