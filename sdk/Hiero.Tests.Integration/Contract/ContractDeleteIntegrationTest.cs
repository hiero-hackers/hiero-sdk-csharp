...
{
    /// <include file="ContractDeleteIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.ContractDeleteIntegrationTest"]' />
    public class ContractDeleteIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractDeleteIntegrationTest.CanDeleteContractWithAdminKey"]' />
        public virtual void CanDeleteContractWithAdminKey()
        {
        ...
        [Fact]
        /// <include file="ContractDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractDeleteIntegrationTest.CannotDeleteContractWhichHasNoAdminKey"]' />
        public virtual void CannotDeleteContractWhichHasNoAdminKey()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
        ...
        [Fact]
        /// <include file="ContractDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractDeleteIntegrationTest.CannotDeleteContractWhenContractIDIsNotSet"]' />
        public virtual void CannotDeleteContractWhenContractIDIsNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
