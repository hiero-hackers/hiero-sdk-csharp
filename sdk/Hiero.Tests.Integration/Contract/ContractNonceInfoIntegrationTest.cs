...
{
    /// <include file="ContractNonceInfoIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.ContractNonceInfoIntegrationTest"]' />
    public class ContractNonceInfoIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractNonceInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractNonceInfoIntegrationTest.CanIncrementNonceThroughContractConstructor"]' />
