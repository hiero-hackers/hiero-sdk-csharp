...
{
    /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.ContractCallIntegrationTest"]' />
    public class ContractCallIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCallIntegrationTest.CanCallContractFunction"]' />
        public virtual void CanCallContractFunction()
        {
        ...
        [Fact]
        /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCallIntegrationTest.CannotCallContractFunctionWhenContractFunctionIsNotSet"]' />
        public virtual void CannotCallContractFunctionWhenContractFunctionIsNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
        ...
        [Fact]
        /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCallIntegrationTest.CannotCallContractFunctionWhenGasIsNotSet"]' />
        public virtual void CannotCallContractFunctionWhenGasIsNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
        ...
        [Fact]
        /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCallIntegrationTest.CannotCallContractFunctionWhenContractIDIsNotSet"]' />
        public virtual void CannotCallContractFunctionWhenContractIDIsNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
        ...
        [Fact]
        /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCallIntegrationTest.GetCostBigMaxContractCallFunction"]' />
        public virtual void GetCostBigMaxContractCallFunction()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
        ...
        [Fact]
        /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCallIntegrationTest.GetCostSmallMaxContractCallFunction"]' />
        public virtual void GetCostSmallMaxContractCallFunction()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
        ...
        [Fact]
        /// <include file="ContractCallIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCallIntegrationTest.GetCostInsufficientTxFeeContractCallFunction"]' />
        public virtual void GetCostInsufficientTxFeeContractCallFunction()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction
