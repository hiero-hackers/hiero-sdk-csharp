...
{
    /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.ContractCreateTransactionHooksIntegrationTest"]' />
    public class ContractCreateTransactionHooksIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithBasicLambdaHookSucceeds"]' />
        public virtual void ContractCreateWithBasicLambdaHookSucceeds()
        {
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithLambdaHookAndStorageUpdatesSucceeds"]' />
        public virtual void ContractCreateWithLambdaHookAndStorageUpdatesSucceeds()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                ContractId hookContractId = EntityHelper.CreateContract(testEnv, testEnv.OperatorKey);
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithDuplicateHookIdsFailsPrecheck"]' />
        public virtual void ContractCreateWithDuplicateHookIdsFailsPrecheck()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                ContractId hookContractId = EntityHelper.CreateContract(testEnv, testEnv.OperatorKey);
        ...
        [Fact]
        /// <include file="ContractCreateTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractCreateTransactionHooksIntegrationTest.ContractCreateWithLambdaHookAndAdminKeySucceeds"]' />
        public virtual void ContractCreateWithLambdaHookAndAdminKeySucceeds()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                ContractId hookContractId = EntityHelper.CreateContract(testEnv, testEnv.OperatorKey);
