...
{
    /// <include file="ContractInfoIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.ContractInfoIntegrationTest"]' />
    public class ContractInfoIntegrationTest
    {
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractInfoIntegrationTest.CanQueryContractInfo"]' />
        public virtual void CanQueryContractInfo()
        {
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractInfoIntegrationTest.CanQueryContractInfoWhenAdminKeyIsNull"]' />
        public virtual void CanQueryContractInfoWhenAdminKeyIsNull()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction()
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractInfoIntegrationTest.CannotQueryContractInfoWhenContractIDIsNotSet"]' />
        public virtual void CannotQueryContractInfoWhenContractIDIsNotSet()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractInfoIntegrationTest.GetCostBigMaxContractInfoFunction"]' />
        public virtual void GetCostBigMaxContractInfoFunction()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction()
                ...
                {
                    ContractId = contractId,
                    MaxQueryPayment = new Hbar(10000)
                };
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractInfoIntegrationTest.GetCostSmallMaxContractInfoFunction"]' />
        public virtual void GetCostSmallMaxContractInfoFunction()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction()
        ...
        [Fact]
        /// <include file="ContractInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ContractInfoIntegrationTest.GetCostInsufficientTxFeeContractInfoFunction"]' />
        public virtual void GetCostInsufficientTxFeeContractInfoFunction()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                var response = new FileCreateTransaction()
