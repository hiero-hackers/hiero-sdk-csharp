...
{
    /// <include file="AccountDeleteIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.AccountDeleteIntegrationTest"]' />
    public class AccountDeleteIntegrationTest
    {
        [Fact]
        /// <include file="AccountDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.AccountDeleteIntegrationTest.CanDeleteAccount"]' />
        ...
        [Fact]
        /// <include file="AccountDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.AccountDeleteIntegrationTest.CannotCreateAccountWithNoKey"]' />
        ...
        [Fact]
        /// <include file="AccountDeleteIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.AccountDeleteIntegrationTest.CannotDeleteAccountThatHasNotSignedTransaction"]' />
