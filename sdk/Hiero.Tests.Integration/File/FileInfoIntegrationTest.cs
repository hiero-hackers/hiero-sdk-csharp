...
{
    /// <include file="FileInfoIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.FileInfoIntegrationTest"]' />
    public class FileInfoIntegrationTest
    {
        [Fact]
        /// <include file="FileInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileInfoIntegrationTest.CanQueryFileInfo"]' />
        ...
        [Fact]
        /// <include file="FileInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileInfoIntegrationTest.CanQueryFileInfoWithNoAdminKeyOrContents"]' />
        ...
        [Fact]
        /// <include file="FileInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileInfoIntegrationTest.GetCostBigMaxQueryFileInfo"]' />
        ...
        [Fact]
        /// <include file="FileInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileInfoIntegrationTest.GetCostSmallMaxQueryFileInfo"]' />
        ...
        [Fact]
        /// <include file="FileInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileInfoIntegrationTest.GetCostInsufficientTxFeeQueryFileInfo"]' />
