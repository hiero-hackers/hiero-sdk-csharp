...
{
    /// <include file="FileContentsIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.FileContentsIntegrationTest"]' />
	public class FileContentsIntegrationTest
	{
        [Fact]
        /// <include file="FileContentsIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileContentsIntegrationTest.CanQueryFileContents"]' />
        ...
        [Fact]
        /// <include file="FileContentsIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileContentsIntegrationTest.CanQueryEmptyFileContents"]' />
        ...
        [Fact]
        /// <include file="FileContentsIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileContentsIntegrationTest.CannotQueryFileContentsWhenFileIDIsNotSet"]' />
        ...
        [Fact]
        /// <include file="FileContentsIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileContentsIntegrationTest.GetCostBigMaxQueryFileContents"]' />
        ...
        [Fact]
        /// <include file="FileContentsIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileContentsIntegrationTest.GetCostSmallMaxQueryFileContents"]' />
        ...
        [Fact]
        /// <include file="FileContentsIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileContentsIntegrationTest.GetCostInsufficientTxFeeQueryFileContents"]' />
