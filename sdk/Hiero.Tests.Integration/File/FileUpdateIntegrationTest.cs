...
{
    /// <include file="FileUpdateIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.FileUpdateIntegrationTest"]' />
    public class FileUpdateIntegrationTest
    {
        [Fact]
        /// <include file="FileUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileUpdateIntegrationTest.CanUpdateFile"]' />
        ...
        [Fact]
        /// <include file="FileUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileUpdateIntegrationTest.CannotUpdateImmutableFile"]' />
        ...
        [Fact]
        /// <include file="FileUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileUpdateIntegrationTest.CannotUpdateFileWhenFileIDIsNotSet"]' />
        ...
        [Fact]
        /// <include file="FileUpdateIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.FileUpdateIntegrationTest.CanUpdateFeeScheduleFile"]' />
