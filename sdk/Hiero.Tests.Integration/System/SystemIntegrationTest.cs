...
namespace Hiero.Tests.Integration.System
{
    /// <include file="SystemIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.SystemIntegrationTest"]' />
    public class SystemIntegrationTest
    {
        ...
        [Fact]
        /// <include file="SystemIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.SystemIntegrationTest.AllSystemTransactionsAreNotSupported"]' />
        public virtual void AllSystemTransactionsAreNotSupported()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                ...
                }); Assert.Contains(ResponseStatus.NotSupported.ToString(), exception1.Message);
                ...
                }); Assert.Contains(ResponseStatus.NotSupported.ToString(), exception2.Message);
                ...
                }); Assert.Contains(ResponseStatus.NotSupported.ToString(), exception3.Message);
            }
        }
    }
}
