...
{
    /// <include file="TransferTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TransferTransactionHooksIntegrationTest"]' />
    public class TransferTransactionHooksIntegrationTest
    {
        ...
        [Fact]
        /// <include file="TransferTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransferTransactionHooksIntegrationTest.TransferWithPreTransactionAllowanceHookSucceeds"]' />
        public virtual void TransferWithPreTransactionAllowanceHookSucceeds()
        {
            using (var testEnv = new IntegrationTestEnv(1))
            {
                ...
                var transferResponse = new TransferTransaction()
                    .SetNodeAccountIds(testEnv.Client.Network_.Network_Read.Keys)
        ...
        [Fact]
        /// <include file="TransferTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransferTransactionHooksIntegrationTest.MultipleAccountsHooksMustAllApprove"]' />
        ...
        [Fact]
        /// <include file="TransferTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransferTransactionHooksIntegrationTest.TransferWithPrePostTransactionAllowanceHookSucceeds"]' />
        ...
        [Fact]
        /// <include file="TransferTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransferTransactionHooksIntegrationTest.FungibleTokenTransferWithAllowanceHookSucceeds"]' />
        ...
        [Fact]
        /// <include file="TransferTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransferTransactionHooksIntegrationTest.NftTransferWithAllowanceHookSucceeds"]' />
        ...
        [Fact]
        /// <include file="TransferTransactionHooksIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransferTransactionHooksIntegrationTest.SenderAndReceiverHooksExecuteForHbarTransfer"]' />
