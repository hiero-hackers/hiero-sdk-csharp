...
{
    /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TransactionIntegrationTest"]' />
    public class TransactionIntegrationTest
    {
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeCompareFields"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeWithNodeAccountIdsDeserializeCompareFields"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeAndExecuteIncompleteTransaction"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeAndExecuteIncompleteTransactionWithNodeAccountIds"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeEditExecuteCompareFields"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeEditExecuteCompareFieldsIncompleteTransactionWithNodeAccountIds"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanFreezeSignSerializeDeserializeReserializeAndExecute"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanFreezeSerializeDeserializeAddSignatureAndExecute"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanFreezeSignSerializeDeserializeAndCompareFileAppendChunkedTransaction"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeExecuteFileAppendChunkedTransaction"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeExecuteIncompleteFileAppendChunkedTransactionWithNodeAccountIds"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanFreezeSignSerializeDeserializeAndCompareTopicMessageSubmitChunkedTransaction"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeExecuteIncompleteTopicMessageSubmitChunkedTransaction"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanSerializeDeserializeExecuteIncompleteTopicMessageSubmitChunkedTransactionWithNodeAccountIds"]' />
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.TransactionFromToBytes2"]' />
        public virtual void TransactionFromToBytes2()
        {
			var id = TransactionId.Generate(new AccountId(0, 0, 542348));
			var transactionBodyBuilder = new Proto.Services.TransactionBody
            {
				GenerateRecord = false,
				Memo = "",
				TransactionId = new Proto.Services.TransactionID
                {
                    AccountId = new Proto.Services.AccountID
                    {
						AccountNum = 542348,
						RealmNum = 0,
						ShardNum = 0
				...
				TransactionValidDuration = new Proto.Services.Duration { Seconds = 120 },
                CryptoTransfer = new Proto.Services.CryptoTransferTransactionBody
                {
                    Transfers = new Proto.Services.TransferList(),
				},
			};
            transactionBodyBuilder.CryptoTransfer.Transfers.AccountAmounts.Add(new Proto.Services.AccountAmount { Amount = 10, AccountId = new Proto.Services.AccountID { AccountNum = 47439, RealmNum = 0, ShardNum = 0 } });
            transactionBodyBuilder.CryptoTransfer.Transfers.AccountAmounts.Add(new Proto.Services.AccountAmount { Amount = -10, AccountId = new Proto.Services.AccountID { AccountNum = 542348, RealmNum = 0, ShardNum = 0 } });
			...
			var signedBuilder = new Proto.Services.SignedTransaction()
            {
                BodyBytes = bodyBytes,
                SigMap = new Proto.Services.SignatureMap { }
            };
            signedBuilder.SigMap.SigPair.Add(new Proto.Services.SignaturePair { Ed25519 = ByteString.CopyFrom(signature1), PubKeyPrefix = ByteString.CopyFrom(publicKey1.ToBytes()) });
            signedBuilder.SigMap.SigPair.Add(new Proto.Services.SignaturePair { Ed25519 = ByteString.CopyFrom(signature2), PubKeyPrefix = ByteString.CopyFrom(publicKey2.ToBytes()) });
            signedBuilder.SigMap.SigPair.Add(new Proto.Services.SignaturePair { Ed25519 = ByteString.CopyFrom(signature3), PubKeyPrefix = ByteString.CopyFrom(publicKey3.ToBytes()) });
            signedBuilder.SigMap.SigPair.Add(new Proto.Services.SignaturePair { Ed25519 = ByteString.CopyFrom(signature4), PubKeyPrefix = ByteString.CopyFrom(publicKey4.ToBytes()) });
            signedBuilder.SigMap.SigPair.Add(new Proto.Services.SignaturePair { Ed25519 = ByteString.CopyFrom(signature5), PubKeyPrefix = ByteString.CopyFrom(publicKey5.ToBytes()) });

			var byts = signedBuilder.ToByteString();
            var list = new Proto.SDK.TransactionList(); list.TransactionList_.Add(new Proto.Services.Transaction { SignedTransactionBytes = byts });
        ...
        [Fact]
        /// <include file="TransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TransactionIntegrationTest.CanAddSignatureToTransaction"]' />
