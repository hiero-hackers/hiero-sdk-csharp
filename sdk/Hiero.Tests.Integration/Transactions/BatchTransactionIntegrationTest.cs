...
{
    /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.BatchTransactionIntegrationTest"]' />
    public class BatchTransactionIntegrationTest
    {
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.CanCreateBatchTransaction"]' />
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.CanExecuteFromToBytes"]' />
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.CanExecuteLargeBatchTransactionUpToMaximumRequestSize"]' />
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.BatchTransactionWithoutInnerTransactionsShouldThrowAnError"]' />
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.BatchTransactionWithBlacklistedInnerTransactionShouldThrowAnError"]' />
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.BatchTransactionWithInvalidBatchKeyInsideInnerTransactionShouldThrowAnError"]' />
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.ChunkedInnerTransactionsShouldBeExecutedSuccessfully"]' />
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.CanExecuteWithDifferentBatchKeys"]' />
        public virtual void CanExecuteWithDifferentBatchKeys()
        {
            using (var testEnv = new IntegrationTestEnv(1).UseThrowawayAccount())
            {
                ...
                {
                    InnerTransactions = new (batchedTransfer1, batchedTransfer2, batchedTransfer3)
                }
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.SuccessfulInnerTransactionsShouldIncurFeesEvenThoughOneFailed"]' />
        public virtual void SuccessfulInnerTransactionsShouldIncurFeesEvenThoughOneFailed()
        {
            using (var testEnv = new IntegrationTestEnv(1).UseThrowawayAccount())
            {
                ...
                ReceiptStatusException exception = Assert.Throws<ReceiptStatusException>(() =>
                {
                    new BatchTransaction
                    {
                        InnerTransactions = new (tx1, tx2, tx3)
                    }
                    .Execute(testEnv.Client)
                    .GetReceipt(testEnv.Client);
                });
        ...
        [Fact]
        /// <include file="BatchTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.BatchTransactionIntegrationTest.TransactionShouldFailWhenBatchified"]' />
