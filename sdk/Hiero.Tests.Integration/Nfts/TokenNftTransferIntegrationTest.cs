...
{
    /// <include file="TokenNftTransferIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenNftTransferIntegrationTest"]' />
    public class TokenNftTransferIntegrationTest
    {
        [Fact]
        /// <include file="TokenNftTransferIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenNftTransferIntegrationTest.CanTransferNfts"]' />
        ...
        [Fact]
        /// <include file="TokenNftTransferIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenNftTransferIntegrationTest.CannotTransferUnownedNfts"]' />
