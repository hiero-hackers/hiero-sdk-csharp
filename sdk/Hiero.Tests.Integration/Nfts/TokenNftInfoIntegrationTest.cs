...
{
    /// <include file="TokenNftInfoIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.TokenNftInfoIntegrationTest"]' />
    public class TokenNftInfoIntegrationTest
    {
        [Fact]
        /// <include file="TokenNftInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenNftInfoIntegrationTest.CanQueryNftInfoByNftId"]' />
        ...
        [Fact]
        /// <include file="TokenNftInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenNftInfoIntegrationTest.CannotQueryNftInfoByInvalidNftId"]' />
        ...
        [Fact]
        /// <include file="TokenNftInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenNftInfoIntegrationTest.CannotQueryNftInfoByInvalidSerialNumber"]' />
        ...
        [Fact]
        /// <include file="TokenNftInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenNftInfoIntegrationTest.CanQueryNftInfoByAccountId"]' />
        ...
        [Fact]
        /// <include file="TokenNftInfoIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.TokenNftInfoIntegrationTest.CanQueryNftInfoByTokenId"]' />
