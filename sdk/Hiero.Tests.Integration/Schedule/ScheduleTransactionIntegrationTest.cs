...
{
    /// <include file="ScheduleTransactionIntegrationTest.cs.xml" path='docs/member[@name="T:Hiero.Tests.Integration.ScheduleTransactionIntegrationTest"]' />
    public class ScheduleTransactionIntegrationTest
    {
        [Fact]
        /// <include file="ScheduleTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ScheduleTransactionIntegrationTest.ShouldChargeHbarsWithLimitUsingScheduledTransaction"]' />
        ...
        [Fact]
        /// <include file="ScheduleTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ScheduleTransactionIntegrationTest.ShouldNotChargeHbarsWithLowerLimitUsingScheduledTransaction"]' />
        ...
        [Fact]
        /// <include file="ScheduleTransactionIntegrationTest.cs.xml" path='docs/member[@name="M:Hiero.Tests.Integration.ScheduleTransactionIntegrationTest.ShouldNotChargeTokensWithLowerLimitUsingScheduledTransaction"]' />
