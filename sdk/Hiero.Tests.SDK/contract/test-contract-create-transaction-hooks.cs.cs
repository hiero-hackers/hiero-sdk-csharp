...
{
    /// <include file="test-contract-create-transaction-hooks.cs.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Contract.ContractCreateTransactionHooksTest"]' />
    public class ContractCreateTransactionHooksTest
    {
        [Fact]
        /// <include file="test-contract-create-transaction-hooks.cs.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Contract.ContractCreateTransactionHooksTest.TestContractCreateTransactionWithHooks"]' />
        ...
        [Fact]
        /// <include file="test-contract-create-transaction-hooks.cs.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Contract.ContractCreateTransactionHooksTest.TestContractCreateTransactionSetHooks"]' />
        ...
        [Fact]
        /// <include file="test-contract-create-transaction-hooks.cs.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Contract.ContractCreateTransactionHooksTest.TestContractCreateTransactionHookValidationDuplicateIdsNotBlockedClientSide"]' />
        ...
        [Fact]
        /// <include file="test-contract-create-transaction-hooks.cs.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Contract.ContractCreateTransactionHooksTest.TestContractCreateTransactionProtobufSerialization"]' />
        ...
        [Fact]
        /// <include file="test-contract-create-transaction-hooks.cs.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Contract.ContractCreateTransactionHooksTest.TestContractCreateTransactionEmptyHooks"]' />
        ...
        [Fact]
        /// <include file="test-contract-create-transaction-hooks.cs.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Contract.ContractCreateTransactionHooksTest.TestContractCreateTransactionHooksPersistThroughBytesRoundTrip"]' />
