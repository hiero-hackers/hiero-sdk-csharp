...
{
    /// <include file="test-contract-function-result.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Contract.ContractFunctionResultTest"]' />
    public class ContractFunctionResultTest
    {
        ...
        private static readonly string STRING_ARRAY_RESULT_HEX = 
        ...
        [Fact]
        /// <include file="test-contract-function-result.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Contract.ContractFunctionResultTest.CanGetStringArrayResult"]' />
