...
namespace Hiero.Tests.SDK.HBar
{
    ...
    public class StakingInfoTest
    {
        ...
        [Fact]
        /// <include file="test-hbar-staking-info.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.HBar.StakingInfoTest.ShouldSerializeAccount"]' />
        ...
        [Fact]
        /// <include file="test-hbar-staking-info.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.HBar.StakingInfoTest.ShouldSerializeNode"]' />
