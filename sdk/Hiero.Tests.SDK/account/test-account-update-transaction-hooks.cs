...
{
    /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest"]' />
    public class AccountUpdateTransactionHooksTest
    {
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldAddHookToCreate"]' />
        public virtual void ShouldAddHookToCreate()
        {
            ...
            tx.HookCreationDetails.Operate(_ => _.Add(hookDetails));
            var result = tx;
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldSetHooksToCreate"]' />
        public virtual void ShouldSetHooksToCreate()
        {
            ...
            tx.HookCreationDetails.Operate(_ => hooks);
            var result = tx;
            Assert.Equal(result, tx);
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldAddHookToDelete"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldAddHooksToDelete"]' />
        public virtual void ShouldAddHooksToDelete()
        {
            var tx = new AccountUpdateTransaction();
            var hookIds = new long[] { 123, 456, 789 };
            tx.HookIdsToDelete.Operate(_ => _.AddRange(hookIds));
            var result = tx;
            Assert.Equal(result, tx);
            //Assert.Equal(2, tx.GetHbarTransfers().Count);
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.HooksToCreate"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldGetHooksToDelete"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldThrowWhenAddingHookAfterFreeze"]' />
        public virtual void ShouldThrowWhenAddingHookAfterFreeze()
        {
			...
			InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => tx.HookCreationDetails.Operate(_ => _.Add(hookDetails)));

			Assert.Contains("transaction is immutable", exception.Message);
		}
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldThrowWhenSettingHooksAfterFreeze"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldThrowWhenDeletingHookAfterFreeze"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldThrowWhenDeletingHooksAfterFreeze"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldSerializeHooksInBuild"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldDeserializeHooksFromTransactionBody"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldHandleEmptyHooks"]' />
        ...
        [Fact]
        /// <include file="test-account-update-transaction-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountUpdateTransactionHooksTest.ShouldSupportMultipleHooks"]' />
        public virtual void ShouldSupportMultipleHooks()
        {
            ...
            tx.HookCreationDetails.Operate(_ => _.Add(hookDetails1));
            tx.HookCreationDetails.Operate(_ => _.Add(hookDetails2));
