...
{
    /// <include file="test-account-allowance-approve-transaction.ts.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Account.AccountAllowanceApproveTransactionTest"]' />
    public class AccountAllowanceApproveTransactionTest
    {
        ...
        [Fact]
        /// <include file="test-account-allowance-approve-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountAllowanceApproveTransactionTest.ShouldBytes"]' />
        ...
        [Fact]
        /// <include file="test-account-allowance-approve-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountAllowanceApproveTransactionTest.ShouldBytesNoSetters"]' />
        ...
        [Fact]
        /// <include file="test-account-allowance-approve-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountAllowanceApproveTransactionTest.DeleteNftAllowanceAllSerials"]' />
        ...
        [Fact]
        /// <include file="test-account-allowance-approve-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Account.AccountAllowanceApproveTransactionTest.DeleteNftAllowanceAllSerialsFrozen"]' />
