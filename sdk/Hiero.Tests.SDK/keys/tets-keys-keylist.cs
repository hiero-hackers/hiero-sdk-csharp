...
{
    /// <include file="tets-keys-keylist.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Keys.KeyListTest"]' />
    public class KeyListTest
    {
        ...
        public virtual void FromProtobuf()
        {
            ...
            // Then
            /// <include file="tets-keys-keylist.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.KeyListTest.Contains"]' />
