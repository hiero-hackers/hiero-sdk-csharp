...
{
    /// <include file="tets-keys-privatekey.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Keys.PrivateKeyTest"]' />
    public class PrivateKeyTest
    {
        ...
        [Fact]
        /// <include file="tets-keys-privatekey.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.PrivateKeyTest.Ecdsa"]' />
        public virtual void Ecdsa()
        {
            ...
            Assert.Equal("f3a13a555f1f8cd6532716b8f388bd4e9d8ed0b252743e923114c0c6cbfe414cf791c8e859afd3c12009ecf2cb20dacf01636d80823bcdbd9ec1ce59afe008f0", Hex.ToHexString(signature));
        }
