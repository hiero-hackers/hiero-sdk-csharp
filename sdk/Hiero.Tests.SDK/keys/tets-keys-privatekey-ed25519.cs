...
{
    /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest"]' />
    public class Ed25519PrivateKeyTest
    {
        private const string TEST_KEY_STR = "302e020100300506032b657004220420db484b828e64b2d8f12ce3c0a0e93a0b8cce7af1bb8f39c97732394482538e10";
        private const string TEST_KEY_STR_RAW = "db484b828e64b2d8f12ce3c0a0e93a0b8cce7af1bb8f39c97732394482538e10";
        private const string TEST_KEY_PEM = 
            "-----BEGIN PRIVATE KEY-----\n" +
            "MC4CAQAwBQYDK2VwBCIEINtIS4KOZLLY8SzjwKDpOguMznrxu485yXcyOUSCU44Q\n" +
            "-----END PRIVATE KEY-----\n";
        // generated by hedera-sdk-js, not used anywhere
        private const string MNEMONIC_STRING = "inmate flip alley wear offer often piece magnet surge toddler submit right radio absent pear floor belt raven price stove replace reduce plate home";
        private const string MNEMONIC_PRIVATE_KEY = "302e020100300506032b657004220420853f15aecd22706b105da1d709b4ac05b4906170c2b9c7495dff9af49e1391da";
        private const string MNEMONIC_LEGACY_STRING = "jolly kidnap tom lawn drunk chick optic lust mutter mole bride galley dense member sage neural widow decide curb aboard margin manure";
        private const string MNEMONIC_LEGACY_PRIVATE_KEY = "302e020100300506032b657004220420882a565ad8cb45643892b5366c1ee1c1ef4a730c5ce821a219ff49b6bf173ddf";
        // backup phrase generated by the iOS wallet, not used anywhere
        private const string IOS_MNEMONIC_STRING = "tiny denial casual grass skull spare awkward indoor ethics dash enough flavor good daughter early hard rug staff capable swallow raise flavor empty angle";
        // private key for "default account", should be index 0
        private const string IOS_DEFAULT_PRIVATE_KEY = "5f66a51931e8c99089472e0d70516b6272b94dd772b967f8221e1077f966dbda2b60cf7ee8cf10ecd5a076bffad9a7c7b97df370ad758c0f1dd4ef738e04ceb6";
        // backup phrase generated by the Android wallet, also not used anywhere
        private const string ANDROID_MNEMONIC_STRING = "ramp april job flavor surround pyramid fish sea good know blame gate village viable include mixed term draft among monitor swear swing novel track";
        // private key for "default account", should be index 0
        private const string ANDROID_DEFAULT_PRIVATE_KEY = "c284c25b3a1458b59423bc289e83703b125c8eefec4d5aa1b393c2beb9f2bae66188a344ba75c43918ab12fa2ea4a92960eca029a2320d8c6a1c3b94e06c9985";
        private const string PEM_PASSPHRASE = "this is a passphrase";
        private const string TEST_VECTOR_PEM_PASSPHRASE = "asdasd123";
        /*
    ...
    */
        private const string ENCRYPTED_PEM = 
        ...
        private const string MESSAGE_STR = "This is a message about the world.";
        private const string SIG_STR = "73bea53f31ca9c42a422ecb7516ec08d0bbd1a6bfd630ccf10ec1872454814d29f4a8011129cd007eab544af01a75f508285b591e5bed24b68f927751e49e30e";
        private static readonly byte[] MESSAGE_BYTES = Encoding.UTF8.GetBytes(MESSAGE_STR);

        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyGenerates"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeySerialization"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeySerialization2"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeySerialization3"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyStringification"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyStringification2"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyStringification3"]' />
        ...
        [Theory]
        [InlineData(TEST_KEY_STR)]
        [InlineData(TEST_KEY_STR_RAW + "e0c8ec2758a5879ffac226a13c0c516b799e72e35141a0dd828f94d37988a4b7")] // raw hex (concatenated private + public key)
        [InlineData(TEST_KEY_STR_RAW)] // raw hex (just private key)
        public virtual void ExternalKeyDeserialize(string keyStr)
        {
            ...
            Assert.Equal(TEST_KEY_STR, key.ToString());
            Assert.Equal(TEST_KEY_STR, key.ToStringDER());
            Assert.Equal(TEST_KEY_STR_RAW, key.ToStringRaw());
        }
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyToString"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyFromMnemonic"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.ValidateLegacyMnemonic"]' />
        public virtual void ValidateLegacyMnemonic()
        {
            ...
            Assert.Equal(MNEMONIC_LEGACY_PRIVATE_KEY, key.LegacyDerive(-1).ToString());
        }
        [Fact]
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.DeriveKeyIndex0"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyFromGeneratedMnemonic24"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyFromGeneratedMnemonic12"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyFromEncryptedPem"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.ErrorKeyFromEncryptedPemNoPassphrase"]' />
        public virtual void ErrorKeyFromEncryptedPemNoPassphrase()
        {
            ...
            // TODO: Assert.Equal("PEM file contained an encrypted private key but no passphrase was given", exception.Message);
        }
        ...
        [InlineData(TEST_KEY_STR_RAW + "e0c8ec2758a5879ffac226a13c0c516b799e72e35141a0dd828f94d37988a4b7")] // raw hex (concatenated private + public key)
        [InlineData(TEST_KEY_STR_RAW)] // raw hex (just private key)
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.ReproducibleSignature"]' />
        public virtual void ReproducibleSignature(string keyStr)
        {
            PrivateKey key = PrivateKey.FromString(keyStr);
            byte[] signature = key.Sign(MESSAGE_BYTES);
            Assert.Equal(SIG_STR, Hex.ToHexString(signature));
        }
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyIsECDSA"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.KeyIsNotEd25519"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.Slip10TestVector1"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.Slip10TestVector2"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.PEMImportTestVectors"]' />
        ...
        [Fact]
        /// <include file="tets-keys-privatekey-ed25519.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Keys.Ed25519PrivateKeyTest.DERImportTestVectors"]' />
