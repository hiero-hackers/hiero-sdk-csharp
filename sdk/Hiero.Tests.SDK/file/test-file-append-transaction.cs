...
{
    /// <include file="test-file-append-transaction.ts.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.File.FileAppendTransactionTest"]' />
    public class FileAppendTransactionTest
    {
        ...
        [Fact]
        /// <include file="test-file-append-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileAppendTransactionTest.ShouldBytesNoSetters"]' />
        ...
        [Fact]
        /// <include file="test-file-append-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileAppendTransactionTest.ShouldBytes"]' />
        ...
        [Fact]
        /// <include file="test-file-append-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileAppendTransactionTest.FromScheduledTransaction"]' />
