...
namespace Hiero.Tests.SDK.File
{
    ...
    public class FileIdTest
    {
        ...
        [Fact]
        /// <include file="test-file-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileIdTest.GetAddressBookFileIdForReturnsCorrectFileId"]' />
        ...
        [Fact]
        /// <include file="test-file-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileIdTest.GetFeeScheduleFileIdForReturnsCorrectFileId"]' />
        ...
        [Fact]
        /// <include file="test-file-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileIdTest.GetExchangeRatesFileIdForReturnsCorrectFileId"]' />
        ...
        [Fact]
        /// <include file="test-file-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileIdTest.TestFileIdFromEvmAddressIncorrectAddress"]' />
        ...
        [Fact]
        /// <include file="test-file-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileIdTest.TestFileIdFromEvmAddress"]' />
        ...
        [Fact]
        /// <include file="test-file-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.File.FileIdTest.TestFileIdToEvmAddress"]' />
