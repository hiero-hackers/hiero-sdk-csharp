...
{
    /// <include file="test-hook-fungiblecall.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Hook.FungibleHookCallTest"]' />
    public class FungibleHookCallTest
    {
        [Fact]
        /// <include file="test-hook-fungiblecall.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.FungibleHookCallTest.ConstructorWithNumericIdAndType"]' />
        ...
        [Fact]
        /// <include file="test-hook-fungiblecall.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.FungibleHookCallTest.HbarTransferSerializesHookByType"]' />
        ...
        [Fact]
        /// <include file="test-hook-fungiblecall.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.FungibleHookCallTest.TokenTransferSerializesHookByType"]' />
