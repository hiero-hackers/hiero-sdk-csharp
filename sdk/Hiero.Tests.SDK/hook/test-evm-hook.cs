...
{
    /// <include file="test-evm-hook.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Hook.EvmHookTest"]' />
    public class EvmHookTest
    {
        [Fact]
        /// <include file="test-evm-hook.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookTest.GettersReturnExpectedAndStorageUpdatesAreImmutable"]' />
        public virtual void GettersReturnExpectedAndStorageUpdatesAreImmutable()
        {
            ...
            Assert.Equal(contractId, hook.ContractId);
            
            var updates = hook.StorageUpdates;
        ...
        [Fact]
        /// <include file="test-evm-hook.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookTest.EqualsAndHashCodeDependOnSpecAndUpdates"]' />
        ...
        [Fact]
        /// <include file="test-evm-hook.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookTest.ToStringContainsSpecAndUpdates"]' />
