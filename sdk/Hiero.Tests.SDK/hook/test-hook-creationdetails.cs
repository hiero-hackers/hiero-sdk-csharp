...
{
    /// <include file="test-hook-creationdetails.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Hook.HookCreationDetailsTest"]' />
    public class HookCreationDetailsTest
    {
        [Fact]
        /// <include file="test-hook-creationdetails.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.HookCreationDetailsTest.GettersAndHasAdminKeyWork"]' />
        ...
        [Fact]
        /// <include file="test-hook-creationdetails.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.HookCreationDetailsTest.ProtobufRoundTripPreservesValues"]' />
        ...
        [Fact]
        /// <include file="test-hook-creationdetails.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.HookCreationDetailsTest.EqualsAndHashCodeVaryByFields"]' />
        ...
        [Fact]
        /// <include file="test-hook-creationdetails.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.HookCreationDetailsTest.ToStringContainsKeyFields"]' />
