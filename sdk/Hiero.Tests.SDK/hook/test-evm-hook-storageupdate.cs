...
{
    /// <include file="test-evm-hook-storageupdate.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Hook.EvmHookStorageUpdateTest"]' />
    public class EvmHookStorageUpdateTest
    {
        [Fact]
        /// <include file="test-evm-hook-storageupdate.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookStorageUpdateTest.EvmHookStorageSlotConstructsAndDefensiveCopies"]' />
        ...
        [Fact]
        /// <include file="test-evm-hook-storageupdate.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookStorageUpdateTest.EvmHookStorageSlotProtobufRoundTrip"]' />
        ...
        [Fact]
        /// <include file="test-evm-hook-storageupdate.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookStorageUpdateTest.EvmHookMappingEntriesValidation"]' />
        ...
        [Fact]
        /// <include file="test-evm-hook-storageupdate.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookStorageUpdateTest.EvmHookMappingEntriesProtobufRoundTrip"]' />
