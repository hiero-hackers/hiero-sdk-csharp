...
{
    /// <include file="test-evm-hook-mappingentry.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Hook.EvmHookMappingEntryTest"]' />
    public class EvmHookMappingEntryTest
    {
        [Fact]
        /// <include file="test-evm-hook-mappingentry.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookMappingEntryTest.OfKeyBuildsEntryAndCopiesArrays"]' />
        ...
        [Fact]
        /// <include file="test-evm-hook-mappingentry.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookMappingEntryTest.WithPreimageBuildsEntryAndCopiesArrays"]' />
        ...
        [Fact]
        /// <include file="test-evm-hook-mappingentry.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Hook.EvmHookMappingEntryTest.FromProtobufWithoutKeyThrows"]' />
