...
{
    /// <include file="test-exception-maxquerypaymentexceeded.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Exceptions.MaxQueryPaymentExceededExceptionTest"]' />
    public class MaxQueryPaymentExceededExceptionTest
    {
        [Fact]
        /// <include file="test-exception-maxquerypaymentexceeded.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Exceptions.MaxQueryPaymentExceededExceptionTest.ShouldHaveMessage"]' />
