...
{
    /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Transactions.BatchTransactionTest"]' />
    public class BatchTransactionTest
    {
        ...
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldBytes"]' />
        ...
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.SetInnerTransactionsShouldUpdateTransactions"]' />
        public virtual void SetInnerTransactionsShouldUpdateTransactions()
        {
            ...
            batchTransaction.InnerTransactions.Operate(_ => newInnerTransactions);
        ...
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.InnerTransactionsAddShouldAppendTransaction"]' />
        public virtual void InnerTransactionsAddShouldAppendTransaction()
        {
            var batchTransaction = new BatchTransaction();
            var newTransaction = SpawnTestTransactionAccountCreate();
            batchTransaction.InnerTransactions.Operate(_ => _.Add(newTransaction));

            Assert.Equal(batchTransaction.InnerTransactions.Count, 1);
            Assert.Equal(batchTransaction.InnerTransactions[0], newTransaction);
        }
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.GetInnerTransactionIdsShouldReturnCorrectIds"]' />
        ...
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldAllowChainedSetters"]' />
        ...
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldRejectFreezeTransaction"]' />
        public virtual void ShouldRejectFreezeTransaction()
        {
            ...
            {
                batchTransaction.InnerTransactions.Operate(_ => _.Add(freezeTransaction));
            });
            Assert.Contains("Transaction type FreezeTransaction is not allowed in a batch transaction", exception.Message);
		}
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldRejectBatchTransaction"]' />
        public virtual void ShouldRejectBatchTransaction()
        {
			...
			InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(innerBatchTransaction)));
            Assert.Contains("Transaction type BatchTransaction is not allowed in a batch transaction", exception.Message);
		}
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldRejectBlacklistedTransactionInList"]' />
        public virtual void ShouldRejectBlacklistedTransactionInList()
        {
            ...
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.AddRange([validTransaction, freezeTransaction])));
            Assert.Contains("Transaction type FreezeTransaction is not allowed in a batch transaction", exception.Message);
		}
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldRejectUnfrozenTransaction"]' />
        public virtual void ShouldRejectUnfrozenTransaction()
        {
            ...
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(unfrozenTransaction)));
			Assert.Contains("Inner transaction should be frozen", exception.Message);
        }
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldRejectTransactionAfterFreeze"]' />
        public virtual void ShouldRejectTransactionAfterFreeze()
        {
            ...
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(SpawnTestTransactionAccountCreate())));
            Assert.Contains("transaction is immutable", exception.Message);
		}
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldRejectTransactionListAfterFreeze"]' />
        public virtual void ShouldRejectTransactionListAfterFreeze()
        {
            ...
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.AddRange(INNER_TRANSACTIONS)));
			Assert.Contains("transaction is immutable", exception.Message);
		}
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldPreserveTransactionOrder"]' />
        public virtual void ShouldPreserveTransactionOrder()
        {
            ...
            batchTransaction.InnerTransactions.Operate(_ => transactions);
            
            Assert.Equal(batchTransaction.InnerTransactions, [transaction1, transaction2, transaction3]);
        }
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldCreateDefensiveCopyOfTransactionList"]' />
        public virtual void ShouldCreateDefensiveCopyOfTransactionList()
        {
            var batchTransaction = new BatchTransaction();
            List<ITransaction> mutableList = [.. INNER_TRANSACTIONS];
            batchTransaction.InnerTransactions.Operate(_ => mutableList);
            mutableList.Clear();

            Assert.Equal(batchTransaction.InnerTransactions, INNER_TRANSACTIONS);
        }
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldRejectTransactionWithoutBatchKey"]' />
        ...
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldValidateAllTransactionsInList"]' />
        ...
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldValidateMultipleConditions"]' />
        public virtual void ShouldValidateMultipleConditions()
        {
            ...
            InvalidOperationException exception = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(unfrozenTransactionWithoutBatchKey)));
            Assert.Contains("Inner transaction should be frozen", exception.Message);

			// Test frozen transaction with no batch key
			var frozenTransactionWithoutBatchKey = unfrozenTransactionWithoutBatchKey.Freeze();
            InvalidOperationException exception1 = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(frozenTransactionWithoutBatchKey)));
            ...
            InvalidOperationException exception2 = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(blacklistedTransaction)));
            Assert.Contains("FreezeTransaction is not allowed in a batch transaction", exception2.Message);
		}
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldAcceptValidTransaction"]' />
        public virtual void ShouldAcceptValidTransaction()
        {
            ...
            batchTransaction.InnerTransactions.Operate(_ => _.Add(validTransaction));

            Assert.Equal(batchTransaction.InnerTransactions, [validTransaction]);
        }
        [Fact]
        /// <include file="test-transactions-batch.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.BatchTransactionTest.ShouldValidateTransactionStateInOrder"]' />
        public virtual void ShouldValidateTransactionStateInOrder()
        {
            ...
            InvalidOperationException exception1 = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(transaction)));
            ...
            InvalidOperationException exception2 = Assert.Throws<InvalidOperationException>(() => batchTransaction.InnerTransactions.Operate(_ => _.Add(frozenTransaction)));
