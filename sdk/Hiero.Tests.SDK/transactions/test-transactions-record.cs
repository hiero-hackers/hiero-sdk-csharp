...
using Hiero.Tests.SDK.Contract;
...
namespace Hiero.Tests.SDK.Transactions
{
    ...
    public class TransactionRecordTest
    {
        ...
        [Fact]
        /// <include file="test-transactions-record.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransactionRecordTest.ShouldSerialize2"]' />
