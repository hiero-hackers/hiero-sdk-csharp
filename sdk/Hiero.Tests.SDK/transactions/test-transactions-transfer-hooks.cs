...
{
    /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest"]' />
    public class TransferTransactionHooksTest
    {
        [Fact]
        /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest.ShouldAddHbarTransferWithPreTxAllowanceHook"]' />
        ...
        [Fact]
        /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest.ShouldAddHbarTransferWithPrePostTxAllowanceHook"]' />
        ...
        [Fact]
        /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest.ShouldNotAllowNullHookTypeRemovedByTypedAPI"]' />
        ...
        [Fact]
        /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest.ShouldUpdateExistingTransferWithHook"]' />
        ...
        [Fact]
        /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest.ShouldCreateNewTransferWhenExistingTransferHasHook"]' />
        ...
        [Fact]
        /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest.ShouldHandleMultipleAccountsWithHooks"]' />
        ...
        [Fact]
        /// <include file="test-transactions-transfer-hooks.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Transactions.TransferTransactionHooksTest.ShouldThrowExceptionWhenFrozen"]' />
        public virtual void ShouldThrowExceptionWhenFrozen()
        {
            ...
            tx.TransactionId = TransactionId.WithValidStart(AccountId.FromString("0.0.5006"), NodaTime.SystemClock.Instance.GetCurrentInstant());
