...
namespace Hiero.Tests.SDK.Fees
{
    ...
    public class CustomFeeLimitTest
    {
        ...
        [Fact]
        /// <include file="test-fees-custom-limit.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFeeLimitTest.TestGetPayerId"]' />
        public virtual void TestGetPayerId()
        {
            Assert.Equal(TEST_PAYER_ID, TEST_CUSTOM_FEE_LIMIT.PayerId);
        }
        [Fact]
        /// <include file="test-fees-custom-limit.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFeeLimitTest.TestSetPayerId"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-limit.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFeeLimitTest.TestToProtobuf"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-limit.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFeeLimitTest.TestFromProtobuf"]' />
