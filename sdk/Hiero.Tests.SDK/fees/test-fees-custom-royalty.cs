...
{
    /// <include file="test-fees-custom-royalty.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Fees.CustomRoyaltyFeeTest"]' />
    public class CustomRoyaltyFeeTest
    {
        ...
        [Fact]
        /// <include file="test-fees-custom-royalty.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomRoyaltyFeeTest.DeepCloneSubclass"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-royalty.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomRoyaltyFeeTest.GetSetNumerator"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-royalty.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomRoyaltyFeeTest.GetSetDenominator"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-royalty.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomRoyaltyFeeTest.GetSetFallbackFee"]' />
