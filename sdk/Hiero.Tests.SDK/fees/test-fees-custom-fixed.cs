...
{
    /// <include file="test-fees-custom-fixed.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Fees.CustomFixedFeeTest"]' />
    public class CustomFixedFeeTest
    {
        ...
        [Fact]
        /// <include file="test-fees-custom-fixed.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFixedFeeTest.DeepCloneSubclass"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fixed.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFixedFeeTest.GetSetAmount"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fixed.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFixedFeeTest.GetSetDenominatingToken"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fixed.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFixedFeeTest.SetSentinelValueToken"]' />
