...
{
    /// <include file="test-fees-custom-fractional.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Fees.CustomFractionalFeeTest"]' />
    public class CustomFractionalFeeTest
    {
        ...
        [Fact]
        /// <include file="test-fees-custom-fractional.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFractionalFeeTest.DeepCloneSubclass"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fractional.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFractionalFeeTest.GetSetNumerator"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fractional.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFractionalFeeTest.GetSetDenominator"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fractional.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFractionalFeeTest.GetSetMinimumAmount"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fractional.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFractionalFeeTest.GetSetMaximumAmount"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-fractional.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFractionalFeeTest.GetSetAssessmentMethod"]' />
