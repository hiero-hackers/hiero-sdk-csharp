...
{
    /// <include file="test-fees-custom-assessed.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Fees.AssessedCustomFeeTest"]' />
    public class AssessedCustomFeeTest
    {
        ...
        [Fact]
        /// <include file="test-fees-custom-assessed.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.AssessedCustomFeeTest.ShouldBytes"]' />
