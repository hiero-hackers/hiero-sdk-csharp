...
{
    /// <include file="test-fees-schedules.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Fees.FeeSchedulesTest"]' />
    public class FeeSchedulesTest
    {
        ...
        [Fact]
        /// <include file="test-fees-schedules.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.FeeSchedulesTest.ShouldSerialize"]' />
        ...
        [Fact]
        /// <include file="test-fees-schedules.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.FeeSchedulesTest.ShouldSerializeNull"]' />
