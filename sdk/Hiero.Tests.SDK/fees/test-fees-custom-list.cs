...
{
    /// <include file="test-fees-custom-list.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Fees.CustomFeeListTest"]' />
    public class CustomFeeListTest
    {
        ...
        [Fact]
        /// <include file="test-fees-custom-list.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFeeListTest.ShouldSerialize"]' />
        ...
        [Fact]
        /// <include file="test-fees-custom-list.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Fees.CustomFeeListTest.DeepClone"]' />
