...
{
    /// <include file="test-token-relationship.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Token.TokenRelationshipTest"]' />
    public class TokenRelationshipTest
    {
        ...
        [Fact]
        /// <include file="test-token-relationship.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenRelationshipTest.ShouldSerializeTokenRelationship"]' />
