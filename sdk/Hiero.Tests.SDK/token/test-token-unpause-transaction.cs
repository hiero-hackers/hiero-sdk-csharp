...
{
    /// <include file="test-token-unpause-transaction.ts.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Token.TokenUnpauseTransactionTest"]' />
    public class TokenUnpauseTransactionTest
    {
        ...
        [Fact]
        /// <include file="test-token-unpause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenUnpauseTransactionTest.ShouldBytesNoSetters"]' />
        ...
        [Fact]
        /// <include file="test-token-unpause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenUnpauseTransactionTest.ShouldBytesNft"]' />
        ...
        [Fact]
        /// <include file="test-token-unpause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenUnpauseTransactionTest.ConstructTokenUnpauseTransactionFromTransactionBodyProtobuf"]' />
        ...
        [Fact]
        /// <include file="test-token-unpause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenUnpauseTransactionTest.GetSetTokenId"]' />
        ...
        [Fact]
        /// <include file="test-token-unpause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenUnpauseTransactionTest.GetSetTokenIdFrozen"]' />
