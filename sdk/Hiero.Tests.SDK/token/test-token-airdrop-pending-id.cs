...
namespace Hiero.Tests.SDK.Airdrops
{
    /// <include file="test-token-airdrop-pending-id.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Airdrops.PendingAirdropIdTest"]' />
    public class PendingAirdropIdTest
    {
        ...
        [Fact]
        /// <include file="test-token-airdrop-pending-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Airdrops.PendingAirdropIdTest.TestConstructorWithTokenId"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-pending-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Airdrops.PendingAirdropIdTest.TestConstructorWithNftId"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-pending-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Airdrops.PendingAirdropIdTest.TestToProtobufWithTokenId"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-pending-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Airdrops.PendingAirdropIdTest.TestToProtobufWithNftId"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-pending-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Airdrops.PendingAirdropIdTest.TestToString"]' />
