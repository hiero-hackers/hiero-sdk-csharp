...
namespace Hiero.Tests.SDK.Token
{
    ...
    public class TokenIdTest
    {
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.UnitTokenIdFromString"]' />
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.UnitTokenIdChecksumFromString"]' />
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.UnitTokenIdChecksumToString"]' />
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.UnitTokenIdFromStringEVM"]' />
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.UnitTokenIdProtobuf"]' />
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.TestTokenIdFromEvmAddressIncorrectAddress"]' />
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.TestTokenIdFromEvmAddress"]' />
        ...
        [Fact]
        /// <include file="test-token-id.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenIdTest.TestTokenIdToEvmAddress"]' />
