...
namespace Hiero.Tests.SDK.Token
{
    ...
    /// <include file="test-token-info.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Token.TokenInfoTest"]' />
    public class TokenInfoTest
    {
        ...
        */
        ...
        [Fact]
        /// <include file="test-token-info.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenInfoTest.ShouldSerialize"]' />
        public virtual void ShouldSerialize()
        {
            var originalTokenInfo = SpawnTokenInfoExample();
            /// <include file="test-token-info.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenInfoTest.ToBytes"]' />
            byte[] tokenInfoBytes = originalTokenInfo.ToBytes();
            /// <include file="test-token-info.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenInfoTest.FromBytes"]' />
        ...
        [Fact]
        /// <include file="test-token-info.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenInfoTest.FromProtobuf"]' />
        public virtual void FromProtobuf()
        {
            /// <include file="test-token-info.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenInfoTest.ToProtobuf"]' />
