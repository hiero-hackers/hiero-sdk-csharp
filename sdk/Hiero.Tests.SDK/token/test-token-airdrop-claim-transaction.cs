...
{
    /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest"]' />
    public class TokenClaimAirdropTransactionTest
    {
        ...
        [Fact]
        /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest.ShouldBytesNoSetters"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest.TestConstructorSetsDefaultMaxTransactionFee"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest.TestGetAndSetPendingAirdropIds"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest.TestClearPendingAirdropIds"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest.TestAddAllPendingAirdrops"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest.TestOnFreeze"]' />
        ...
        [Fact]
        /// <include file="test-token-airdrop-claim-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenClaimAirdropTransactionTest.TestOnScheduled"]' />
