...
{
    /// <include file="test-token-allowance.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Token.TokenAllowanceTest"]' />
    public class TokenAllowanceTest
    {
        ...
        [Fact]
        /// <include file="test-token-allowance.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenAllowanceTest.ConstructWithTokenIdOwnerSpenderAmount"]' />
        ...
        [Fact]
        /// <include file="test-token-allowance.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenAllowanceTest.FromProtobuf"]' />
        public virtual void FromProtobuf()
        {
            /// <include file="test-token-allowance.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenAllowanceTest.ToProtobuf"]' />
