...
{
    /// <include file="test-token-pause-transaction.ts.cs.xml" path='docs/member[@name="T:Hiero.Tests.SDK.Token.TokenPauseTransactionTest"]' />
    public class TokenPauseTransactionTest
    {
        ...
        [Fact]
        /// <include file="test-token-pause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenPauseTransactionTest.ShouldSerialize"]' />
        public virtual void ShouldSerialize()
        {
            Verifier.Verify(SpawnTestTransaction().ToString());
        }
        [Fact]
        /// <include file="test-token-pause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenPauseTransactionTest.ShouldBytesNft"]' />
        ...
        [Fact]
        /// <include file="test-token-pause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenPauseTransactionTest.ConstructTokenPauseTransactionFromTransactionBodyProtobuf"]' />
        ...
        [Fact]
        /// <include file="test-token-pause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenPauseTransactionTest.GetSetTokenId"]' />
        ...
        [Fact]
        /// <include file="test-token-pause-transaction.ts.cs.xml" path='docs/member[@name="M:Hiero.Tests.SDK.Token.TokenPauseTransactionTest.GetSetTokenIdFrozen"]' />
