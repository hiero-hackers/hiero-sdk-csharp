...
namespace Hiero.SDK
{
    ...
    public sealed class Mnemonic : IMnemonic<Mnemonic>
    {
		...
		internal static int GetWordIndex(string word, bool isLegacy)
		{
		...
		internal static bool[] BytesToBits(byte[] dat)
		{
		...
		internal static int[] ConvertRadix(int[] nums, int fromRadix, int toRadix, int toLength)
		{
		...
		internal static IList<string> EntropyToWords(byte[] entropy)
        {
		...
		internal static IList<string> ReadWordList(bool isLegacy)
		{
			if (isLegacy)
				try
				{
		...
		internal static IList<string> GetWordList(bool isLegacy)
		{
			if (isLegacy)
			{
        ...
        internal byte[] WordsToLegacyEntropy()
        {
		...
		internal byte[] WordsToEntropyAndChecksum()
		{
